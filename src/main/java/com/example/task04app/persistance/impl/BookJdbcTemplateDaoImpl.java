...
public class BookJdbcTemplateDaoImpl implements BookDao {
    ...
    public Book getById(Long id) throws SQLException {
        ...
        Book book = jdbcTemplate.queryForObject(SELECT_BOOK_BY_ID_JDBC_TEMPLATE_SQL_QUERY, param, bookRowMapper);
    ...
    public List<Book> getByAuthor(String author) throws SQLException {
        ...
        bookList = jdbcTemplate.query(SELECT_BOOK_BY_AUTHOR_JDBC_TEMPLATE_SQL_QUERY, param, bookRowMapper);
    ...
    public Book update(Book book) throws SQLException {
        ...
        jdbcTemplate.update(UPDATE_BOOK_JDBC_TEMPLATE_SQL_QUERY, params, keyHolder);
